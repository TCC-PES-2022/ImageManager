...
# TARGET_NAME := libimagemanager.a libimagemanager.so
TARGET_NAME := libimagemanager.a
...
$(OUT_PATH)/libimagemanager.a: $(OBJ)
	@echo "Linking $@"
	$(AR) $(ARFLAGS) $@ $(OBJ)
...
$(OUT_PATH)/libimagemanager.so: $(OBJ)
	@echo "Linking $@"
...
.PHONY: install
install:
	@echo "\n\n *** Installing ImageManager to $(DESTDIR) *** \n\n"
